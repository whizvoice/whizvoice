...
TOOL_SCHEMAS = {
    ...
    "agent_log_health_data": {"params": {"data_type": "str", "value": "float"}, "examples": [
        ("log 400 calories", {"data_type": "calories", "value": 400}),
        ("add 500 calories to my food log", {"data_type": "calories", "value": 500}),
        ("track 1200 calories", {"data_type": "calories", "value": 1200}),
        ("log 300 calories", {"data_type": "calories", "value": 300}),
        ("add 250 calories", {"data_type": "calories", "value": 250}),
        ("log 800 calories", {"data_type": "calories", "value": 800}),
        ("log my weight at 72 kilograms", {"data_type": "weight", "value": 72}),
        ("record my weight as 75 kg", {"data_type": "weight", "value": 75}),
        ("I weigh 68 kilos", {"data_type": "weight", "value": 68}),
        ("log weight 80 kg", {"data_type": "weight", "value": 80}),
        ("track my weight 65 kilograms", {"data_type": "weight", "value": 65}),
        ("save my weight as 90 kg", {"data_type": "weight", "value": 90}),
    ]},
